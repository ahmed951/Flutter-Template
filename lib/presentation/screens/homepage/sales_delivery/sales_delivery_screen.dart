...
class SalesDeliveryScreen extends StatelessWidget {
  SalesDeliveryScreen({super.key});
          ...
          body: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  const DefaultBreadCrumb(items: ["Home", "Sales Delivery"]),
                  vertialSpace(3.h),
                  Text(
                    "Sales Delivery".tr(),
                    style:
                    ...
                    children: [
                      Expanded(
                        child: CupertinoSearchTextField(
                          onChanged: (e) {
                            cubit.searchSalesDelivery();
                          },
                          controller: cubit.salesDeliverySearchController,
                  ...
                  vertialSpace(3.h),
                  if (cubit.salesDeliveryModel != null)
                    ListView.separated(
                      shrinkWrap: true,
                      physics: const NeverScrollableScrollPhysics(),
                      itemCount:
                          cubit.salesDeliverySearchController.text.isEmpty
                              ? cubit.salesDeliveryList.length
                              : cubit.searchSalesDeliveryList.length,
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        var data =
                            cubit.salesDeliverySearchController.text.isEmpty
                                ? cubit.salesDeliveryList[index]
                                : cubit.searchSalesDeliveryList[index];
                        return InkWell(
                          onTap: () {
                            pushNavigate(context, viewSalesDeliveryRoute,
                                arguments: {
                                  "context": context,
                                  "deliveryId": data["Id"]
                                });
